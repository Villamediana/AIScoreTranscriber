...
- Aceita **ficheiro local** ou **URL de vídeo YouTube**.
...
1. Escolhe uma das opções de entrada:
   ...
   - colar uma URL de vídeo YouTube.
...
- **YouTube URL**: o servidor descarrega o áudio temporariamente usando `yt-dlp` e remove o ficheiro após a transcrição.
